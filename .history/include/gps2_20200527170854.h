...
void gps2_get_datetime(struct gps2 *dev, unsigned long date, unsigned long time, unsigned long fix_age);
 
/* returns speed in 100ths of a knot */
void gps2_speed(struct gps2 *dev, unsigned long speed, unsigned long fix_age);
 
/* course in 100ths of a degree */
void gps2_course(struct gps2 *dev, unsigned long course, unsigned long fix_age);
