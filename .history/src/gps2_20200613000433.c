...
void gps2_get_unixtime(struct gps2 *dev, u_int64_t *unixtime, u_int64_t *age) {
  struct tm time;
  time_t epoch;
  ...
  /* add on the microseconds converted to milliseconds */
  epoch = epoch + (dev->datetime.microseconds / 1000);
