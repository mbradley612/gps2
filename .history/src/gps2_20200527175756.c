...
void process_rmc_frame(struct gps2 *gps_dev, struct minmea_sentence_rmc rmc_frame) {
  ...
  gps_dev->datetime.year = rmc_frame.date.day;
  gps_dev->datetime.hours = rmc_frame.date.day;
  gps_dev->datetime.minutes = rmc_frame.date.day;
  gps_dev->datetime.seconds = rmc_frame.date.day;
  gps_dev->datetime.microseconds = rmc_frame.date.day;
